...
export function BlogItem(props) {
  ...
  return (
    <div className="w-80 h-80 flex justify-center items-center  group duration-500 -translate-y-10 scale-100 hover:origin-top-left hover:scale-120 -rotate-12 hover:-rotate-0 hover:translate-x-10  hover:translate-y-1">
